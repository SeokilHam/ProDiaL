...
from train_utils.loss import loss_fn
from train_utils.data_loader import data_loader
from train_utils.data_collator import Seq2SeqCollator
from train_utils.metrics import InstructionMetrics
from train_utils.postprocessor import Postprocessor
from transformers.generation import GenerationConfig
from torch.utils.tensorboard import SummaryWriter
from train_utils.optimizer import OptimizerFactory
...
class Trainer :
    ...
    def __init__(
        ...
        self.optimizer = torch.optim.AdamW(params=params, lr=args.learning_rate)
    ...
    def score_prediction(
        ...
        elif dataset_name == "arc-c" or dataset_name == "arc-e" :
            results = postprocessor.postprocess_multiplce_choice(dataset, prediction, labels)
            metric = insturction_metrics.get_multiple_choice_acc(results)
                ...
                for train_data in train_loader :                    
                    ...
                    if self.args.save_strategy == "steps" :
                        if training_step_ptr % self.args.save_steps == 0 :
                            self.save_model(self.arge.output_dir)
